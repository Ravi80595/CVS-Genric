...
const Dashboard = () => {
    ...
    const [profileData,setProfileData]=useState([' R'])
...
<Flex w='100%'>
    ...
    <Text textAlign={"center"} mb={5} >CSV</Text>
    {/* <hr /> */}
            {/* Side Bar */}
...
{
show==="Users"?<UsersPage/>:show=="Admins"?<AllAdmin/>:show=="Posts"?<ProductPage/>:<h1>Fearture Available Soon</h1>
}
</Box>
</Box>
</Flex>
